...
- [x] Custom policy-as-code (K3) — *internal/policy: CEL packs (kubeguard.io/policy/v1) loaded at runtime, strict validation, scan --policy; 3 examples + docs/custom-policies.md; findings flow through report/gate/SARIF/lifecycle*
